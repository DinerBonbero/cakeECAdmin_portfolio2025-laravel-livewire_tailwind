            ...
            @else
                ...
                @foreach ($saleHistories as $saleHistory)
                    @php
                        ...
                        $orderDetailNum = 0;
                    @endphp
                    <div class="@if ($saleHistory->is_shipped === 0) bg-red-400 @endif">
                        <div class="flex">
                                ...
                                <div class="w-2/9 flex items-center">
                                    @if ($orderDetailNum === 1)
                                        <form wire:submit="update" name="is_shipped">
                                            <livewire:UpdateShippingStatusButton :saleHistoryId="$saleHistory->id" :isSipped="$saleHistory->is_shipped" />
                                        </form>
                                    @endif
                                </div>
                                <div class="w-3/9">
