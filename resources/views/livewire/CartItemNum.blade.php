...
<button wire:click="update('-')" class="text-gray-400 text-2xl absolute left-2">
    -
</button>
...
<button wire:click="update('+')" class="text-gray-400 text-2xl absolute right-2">
    +
</button>
{{-- 必ずdivで囲む 囲まないと動的サイトとして認識しない --}}
</div>
