    ...
    <div class="w-4/11 mx-auto">
        <div class="flex mb-7">
            <div class="ml-5 w-full">
                <p class="my-5 text-lg">登録情報の変更</p>
                <form action="{{ route('user_info.update') }}" method="POST">
                    ...
                    <div class="flex grid-cols-2 justify-between text-left mb-5 text-base">
                        <div>
                            ...
                            <input type="text" id="last_name" name="last_name" value="{{ old('last_name', $userInfo->last_name) }}"
                        ...
                        <div>
                            ...
                            <input type="text" id="first_name" name="first_name" value="{{ old('first_name', $userInfo->first_name) }}"
                    ...
                    <div class="text-left text-base">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" id="postal_code" name="postal_code" value="{{ old('postal_code', $userInfo->postal_code) }}"
                                class="bg-white border-1 border-solid border-gray-200 rounded-sm w-full"
                            ...
                            <select name="prefecture" id="prefecture"
                                ...
                                @foreach (App\Consts\PrefectureConst::List as $prefecture)
                                    <option value="{{ $prefecture }}"
                                        @if (old('prefecture', $userInfo->prefecture) == $prefecture) selected @endif>
                                        {{ $prefecture }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" id="street_address" name="street_address"
                                value="{{ old('street_address', $userInfo->street_address) }}"
                                class="bg-white border-1 border-solid border-gray-200 rounded-sm w-full"
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" id="address_detail" name="address_detail"
                                value="{{ old('address_detail', $userInfo->address_detail) }}"
                                class="bg-white border-1 border-solid border-gray-200 rounded-sm w-full"
