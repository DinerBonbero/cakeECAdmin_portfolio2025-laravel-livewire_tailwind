                    ...
                    <div class="flex flex-col ml-25 w-full text-left">
                        ...
                        <div class="w-full">
                            <div class="mt-5 inline-block relative w-4/11">
                                <livewire:decrement>
                                {{-- <button wire:click="decrement({{ $cartItem->item_id }})"
                                    class="text-gray-400 text-2xl absolute left-2">
                                    -
                                </button> --}}
                                ...
                                {{-- <button wire:click="increment({{ $cartItem->item_id }})"
                                    class="text-gray-400 text-2xl absolute right-2">
                                    +
                                </button> --}}
                                <livewire:increment>
                            </div>
