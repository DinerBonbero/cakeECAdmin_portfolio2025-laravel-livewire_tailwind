    ...
    <div class="w-5/9 mx-auto">
        <div class="flex">
            <input type="file" name="" id=""
                class="w-3/5 bg-white border-1 border-solid border-gray-200 rounded-sm">
        ...
        <div class="text-left pt-7 pb-10 w-full">
            ...
            <textarea name="" id="item_description" class="bg-white border-1 border-solid border-gray-200 rounded-sm w-full" placeholder="ほのかな酸味の苺とあっさりしてコクのある生クリームを使用した、甘すぎないショートケーキです。"></textarea>
                <span class="text-red-500">エラーメッセージ</span>
